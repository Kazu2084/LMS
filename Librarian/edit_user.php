...
<div class="app-content">
	<div>
		<h1 class="app-content-headerText">Edit User</h1>
	</div>
    <div></div>
    <br/>  
  ...
  ?>
                        ...
                        <!---        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="middlename" value="<?php echo $row['middlename']; ?>" id="first-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
