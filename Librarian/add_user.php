...
<div class="app-content">
	<div>
		<h1 class="app-content-headerText">Add User</h1>
	</div>
    <div></div>
    <br/>
                    ...
                    <div class="x_content"> -->
                        <!-- content starts here -->
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left mod-col">
                                ...
                                <div class="form-group">
									<label class="control-label col-md-4" for="last-name">Course<span class="required" style="color:red;">*</span>
									</label>
									<div class="col-md-4">
                                        <select name="level" class="select2_single form-control" required="required" tabindex="-1" >
                                            <option value="Grade 7">BSc IT</option>
                                            <option value="Grade 8">BMM</option>
                                            <option value="Grade 9">BMS</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="section" id="first-name2" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                        <!---        <div class="form-group">
