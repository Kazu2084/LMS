...
<div class="app-content">
	<div>
		<h1 class="app-content-headerText">Edit Book</h1>
	</div>
    <div></div>
    <br/>
...
$row=mysqli_fetch_assoc($query1);
  ?>
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left mod-col">
                                <div class="form-group mod-col">
                                    <label class="control-label col-md-4" for="last-name">Book Image
                                    </label>
                                    <div class="col-md-5">
										<a href=""><?php if($row['book_image'] != ""): ?>
										<img src="../Images/<?php echo $row['book_image']; ?>" width="110px" height="150px" style="border:4px groove #CCCCCC; border-radius:5px;">
										<?php else: ?>
										<img src="images/book_image.jpg" width="100px" height="100px" style="border:4px groove #CCCCCC; border-radius:5px;">
										<?php endif; ?>
										</a>
                                        <input type="file" style="height:37px; margin-top:10px;" name="image" id="last-name2" class="form-control col-md-7 col-xs-12" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" name="book_copies" value="<?php echo $row['book_copies']; ?>" step="1" min="0" max="1000" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <!-- <div class="form-group">
...
mysqli_query($con," UPDATE book SET book_title='$book_title', category_id='$category_id', author='$author', author_2='$author_2', book_copies='$book_copies', 
book_pub='$book_pub', publisher_name='$publisher_name', isbn='$isbn', copyright_year='$copyright_year' WHERE book_id = '$id' ")or die(mysqli_error());
...
mysqli_query($con," UPDATE book SET book_title='$book_title', category_id='$category_id', author='$author', author_2='$author_2', book_copies='$book_copies', 
book_pub='$book_pub', publisher_name='$publisher_name', isbn='$isbn', copyright_year='$copyright_year' $bi WHERE book_id = '$id' ");
echo "<script>alert('Successfully Updated Book Info!'); window.location='book.php'</script>";	
