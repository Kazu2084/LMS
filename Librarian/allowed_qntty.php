                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title mod-col">
								<b><div style="text-align:center; font-size: 20px;">Allowed Books</div></b>
...
<?php	// 	include ('add_modal_example.php'); ?>
							...
							?>
                                            <tr>
                                                <td style="text-align:center;"><?php echo $row11['qntty_books']; ?></td>
									...
									<div class="modal-dialog">
										<div class="modal-content mod-col">
										...
										<div class="modal-body">
												...
												<form method="post" enctype="multipart/form-data" class="form-horizontal">
													<div class="form-group" style="margin-left:170px;">
														<label class="control-label col-md-5" for="first-name">Quantity <span class="required" style="color:red;">*</span>
														</label>
														<div class="col-md-7">
