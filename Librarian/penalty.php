                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
								...
								<b><div style="text-align:center; font-size: 20px;">Penalty</div></b>
...
<?php // 	include ('add_modal_example_2.php'); ?>
							...
							?>
                                            <tr>
                                                <td style="text-align:center;"><?php echo $row33['penalty_amount']."".'.00'; ?></td>
										...
										<div class="modal-body">
												...
												<form method="post" enctype="multipart/form-data" class="form-horizontal">
													<div class="form-group" style="margin-left:170px;">
														<label class="control-label col-md-5" for="first-name">Amount <span class="required" style="color:red;">*</span>
														</label>
														<div class="col-md-7">
