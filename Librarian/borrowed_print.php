	...
	<div class="container">
		<div id="header">
			...
			<img src="images/logo.jpeg"
				style=" margin-top:-17px; float:left; margin-left:115px; margin-bottom:-6px; width:100px; height:100px;">
			<img src="images/logo4.jpg"
				style=" margin-top:-17px; float:right; margin-right:115px; width:100px; height:100px;">
			<center>
				<h5 style="font-style:Calibri"></h5>&nbsp; &nbsp;&nbsp; Republic of the Philippines &nbsp; &nbsp;
			</center>
			<center>
				<h5 style="font-style:Calibri; margin-top:-14px;"></h5> &nbsp; &nbsp; Library Management System
			</center>
			<center>
				<h5 style="font-style:Calibri; margin-top:-14px;"></h5> Valladolid National High School
			</center>

			<button type="submit" id="print" onclick="printPage()">Print</button>
			<p style="margin-left:30px; margin-top:50px; font-size:14pt; font-weight:bold;">Borrowed Books
				Monitoring&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</p>
			<div align="right">
				...
				<tbody>
					...
					while ($borrow_row = mysqli_fetch_array($borrow_query)) {
						...
						<tr>
							...
							<td style="text-align:center;" style="text-transform: capitalize">
								<?php echo $borrow_row['firstname'] . " " . $borrow_row['middlename'] . " " . $borrow_row['lastname']; ?>
							</td>
							<td style="text-align:center;" style="text-transform: capitalize">
								<?php echo $borrow_row['level']; ?>
							</td>
							<td style="text-align:center;" style="text-transform: capitalize">
								<?php echo $borrow_row['section']; ?>
							</td>
							<td style="text-align:center;" style="text-transform: capitalize">
