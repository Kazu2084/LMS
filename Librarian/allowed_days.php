...
<?php //	include ('add_modal_example_3.php'); ?>
                                ...
                                <div class="x_content mod-col">
								<b><div style="text-align:center; font-size: 20px;">Allowable days</div></b>
							...
							?>
                                            <tr>
                                                <td  style="text-align:center"><?php echo $row33['no_of_days']; ?></td>
										...
										<div class="modal-body">
												...
												<form method="post" enctype="multipart/form-data" class="form-horizontal">
													<div class="form-group" style="margin-left:170px;">
														<label class="control-label col-md-4" for="first-name">Days <span class="required" style="color:red">*</span>
														</label>
