...
<div class="app-content" style="padding-bottom: 24px">
	<div>
		<h1 class="app-content-headerText">Add Book</h1>
	</div>
    <div></div>
    <br/>
...
<!-- 
        ...
        <div class="row">
                    ...
                    <div class="x_content"> -->
                        <!-- content starts here -->
							...
							<input type="hidden" name="new_barcode" value="<?php echo $new_barcode; ?>">
                                ...
                                <!-- <div class="form-group">
                                    <label type="hidden" class="control-label col-md-4" for="first-name">Author 3
                                    </label>
                                    <div class="col-md-4">
                                        <input type="hidden" name="author_3" id="first-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="file" name="image" id="last-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
			...
			$error = $_FILES["image"] ["error"];
			{
					...
					{
					mysqli_query($con,"insert into book (book_title,category_id,author,author_2,book_copies,book_pub,publisher_name,isbn,copyright_year,book_barcode,book_image,date_added)
					values('$book_title','$category_id','$author','$author_2','$book_copies','$book_pub','$publisher_name','$isbn','$copyright_year','$gen','$book_image',NOW())")or die(mysqli_error());
